...
def main(argv=None):
    ...
    if args.cmd=='approve-skill': pj(approve_skill(args.skill,args.evaluation,args.approved_dir,args.registry,args.approve,trust_record_path=args.trust_record,prior_trust_record_path=args.prior_trust_record,first_approval=args.first_approval,approval_record_path=args.approval_record,audit_ledger_path=args.audit_ledger)); return 0
