...
from lawfirm_os_skills_registry.domain.trust_surface import extract_provider_metadata, extract_trust_surface
...
def _write_skill(
    ...
    *,
    ...
    meta = {
        ...
        "provider_metadata": {
            "claude": {"plugin_id": "claude-plugin-synthetic-fixture", "workflow_id": "wf-synthetic-fixture"},
        },
    }
    if metadata_extra:
...
def test_claude_identifiers_remain_provider_metadata(tmp_path: Path) -> None:
    ...
    assert "plugin_id" in provider["claude"]
