# Legal Prompt Injection Boundary Review
...
Reviews retrieved text, tool results, browser output, and document payloads for hostile embedded instructions before downstream use.
